...
export default class InfoSchool extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            backups: [{ id: 1,nome:"A" }, { id: 2,nome:"B" }],//lista de Backups
                                ...
                                <tbody>
                                    {this.state.backups.map(b => (
                                        ...
                                        <tr name={b.id} >
                                            ...
                                            <td>{b.id}</td>
                                            <td><Button size="sm" onClick={() => this.controlRecoverBackup(b.nome)} block variant='success'>Restaurar</Button></td>
                                            <td><Button size='sm' onClick={() => this.controlDeleteBackup(b.nome)} block variant='danger' >Excluir</Button></td>
                                        </tr>
                                    ))}
                                </tbody>
                            </Table>
