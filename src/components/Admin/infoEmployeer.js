...
export default class infoEmployeer extends Component {
  constructor() {
    super();
    this.state = {
      //Id do funcionário,recebe como parametro quando o componente for renderizado.
      IDEmployeer: this.props.idEmployeer,
      login: "", //login
      name: "", //nome
      surname: "", //sobrenome
      address: "", //endereço
  ...
  componentDidMount(){
      /*const response = await api.get("/atualizarFuncionário", this.state.IDEmployeer);*/
      /*this.setState({
  ...
  delete(){
      /*const response = await api.get("/atualizarBolsista", this.state.IDEmployeer);*/
  }
